...
{
    internal class ReportFoHertsAtlas : ReportMaster
    {
        /// <summary>
        ...
        /// default constructor
        /// </summary>
        public void ReportForHertsAtlas() { }
        ...
        private void CreateTable()
        {
            ...
            ReportDataGrid.Columns.Add(column);
            column = CreateColumn("Date", "recording.RecordingSession.SessionDate", System.Windows.Visibility.Visible, "ShortDate_Converter");
            ReportDataGrid.Columns.Add(column);
            ...
            ReportDataGrid.Columns.Add(column);
            column = CreateColumn("GridRef", "GridRef", System.Windows.Visibility.Visible, "");
            ReportDataGrid.Columns.Add(column);
            ...
            ReportDataGrid.Columns.Add(column);
            column=CreateColumn("Status","status", System.Windows.Visibility.Visible, "");
            ReportDataGrid.Columns.Add(column);
            column = CreateColumn("Comment", "recording.RecordingStartTime", System.Windows.Visibility.Visible, "ShortTime_Converter");

            ReportDataGrid.Columns.Add(column);
            column=CreateColumn("Observer","session.Operator", System.Windows.Visibility.Visible, "");
            ReportDataGrid.Columns.Add(column);
